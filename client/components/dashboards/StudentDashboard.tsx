...
export default function StudentDashboard({ user }: { user: any }) {
    ...
    const fetchStudyMaterials = async (classId?: string | number) => {
        ...
        try {
            const res = await fetch(`${API}/academic-studio/student-materials?class_id=${classId}`);
            if (res.ok) {
                                                ...
                                                <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                                                    <div>
                                                        ...
                                                        <div className="small text-white-50 mt-0.5">
                                                            Approved notes, summer vacation packs, and classroom presentations from your teachers.
                                                        </div>
                                                    </div>
                                                    {/* Filter badges */}
                                            ...
                                            <div className="card-body p-4 bg-light bg-opacity-25">
                                                {loadingMaterials ? (
                                                    ...
                                                    <div className="text-center py-4 text-muted">
                                                        ...
                                                        <div className="small fw-semibold">No study materials published yet for your class.</div>
                                                    </div>
                                                ) : (
                                                    <div className="row g-3">
                                                        {studyMaterials
                                                                    ...
                                                                    <div className="card border-0 shadow-sm rounded-4 h-100 bg-white hover-shadow transition">
                                                                        <div className="card-body p-3.5 d-flex flex-column justify-content-between">
                                                                            ...
                                                                            <div className="d-flex gap-2 border-top pt-2.5">
                                                                                ...
                                                                                <a
                                                                                    href={`${API}/academic-studio/documents/${mat.id}/export-pdf`}
                                                                                    target="_blank"
                                                        ...
                                                        <div className="col-md-4" key={i}>
                                                            <div className="card h-100 border-0 shadow-sm hover-shadow transition bg-light">
                                                                <div className="card-body text-center p-3.5">
                                                                    ...
                                                                    <a href={`${API}/${doc}`} target="_blank" className="btn btn-sm btn-outline-primary rounded-pill mt-2 px-3">
